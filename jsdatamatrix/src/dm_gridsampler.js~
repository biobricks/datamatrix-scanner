/*
  ...
  Additional work by Marc Juul - BioBricks Foundation
...
var PerspectiveTransform = require('./perspective-transform.js');
...
GridSampler.sampleGrid4 = function(image, dimensionX, dimensionY, transform) {
...
//            var xpoint = (Math.floor( points[x]) * 4) + (Math.floor( points[x + 1]) * image.width * 4);
              var bit = image.get(Math.floor(points[x]), Math.floor(points[x + 1]));
...
GridSampler.sampleGrid = function(image,
                       dimensionX,
                       dimensionY,
                       p1ToX, p1ToY,
                       p2ToX, p2ToY,
    ...
    return GridSampler.sampleGrid4(image, dimensionX, dimensionY, transform);
}
