 ...
 */
function ECBlocks(ecCodewords, ecBlocks, ecBlocks2) {

    this.ecCodewords = ecCodewords;
    this.ecBlocks = [ecBlocks];
    if(ecBlocks2) this.ecBlocks.push(ecBlocks2);

    this.getECCodewords = function() {
...
function Version(versionNumber,
    ...
    this.getSymbolSizeRows = function() {
        return this.symbolSizeRows;
    }
    
    this.getSymbolSizeColumns = function() {
        return this.symbolSizeColumns;
    }
    
    this.getDataRegionSizeRows = function() {
        return this.dataRegionSizeRows;
    }
    
    this.getDataRegionSizeColumns = function() {
    ...
    for(ecBlock in ecbArray) {
        total += ecbArray[ecBlock].getCount() * (ecbArray[ecBlock].getDataCodewords() + ecCodewords);
    }
